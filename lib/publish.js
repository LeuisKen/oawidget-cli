...
function main() {
    ...
    var postUrl = (() => {
        const packageConfigPath = packageObj.config.uploadHost;
        const oaConfigPath = oapathObj.uploadHost;
        if (packageConfigPath) {
            return packageConfigPath;
        }
        else if(oaConfigPath) {
            return oaConfigPath;
        }
        return 'http://eop.baidu.com/v2/upload/widget';
    })();
